                    ...
                    <div class="">
                        <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <textarea name="details" class="form-control @error('details') is-invalid @enderror" id="details" cols="30" rows="10" placeholder="About Category">{{$product->details}}</textarea>
                                @error('details')
                                <p class="font-weight-bold h5 text-danger">{{ $message }}</p>
                                @enderror
                            </div>
